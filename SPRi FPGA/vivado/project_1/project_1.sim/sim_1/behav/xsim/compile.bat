...
REM
REM Generated by Vivado on Mon Jun 08 10:10:04 +0530 2026
...
echo "xvlog --incr --relax -prj tb_bg_subtraction_vlog.prj"
call xvlog  --incr --relax -prj tb_bg_subtraction_vlog.prj -log xvlog.log
