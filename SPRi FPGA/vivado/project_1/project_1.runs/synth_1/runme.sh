...
HD_PWD='C:/Users/mnbor/OneDrive/Documents/Internship/codes/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bg_subtraction.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bg_subtraction.tcl
