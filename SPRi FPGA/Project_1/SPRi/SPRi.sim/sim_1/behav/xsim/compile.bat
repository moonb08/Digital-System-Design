...
REM
REM Generated by Vivado on Mon Jun 29 01:33:03 +0530 2026
...
echo "xvlog --incr --relax -prj tb_spr_pipeline_vlog.prj"
call xvlog  --incr --relax -prj tb_spr_pipeline_vlog.prj -log xvlog.log
